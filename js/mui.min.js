...
/*function ImmersedStatusbar(){
	//沉浸式状态栏
	var isImmersedStatusbar = plus.navigator.isImmersedStatusbar();
	if(isImmersedStatusbar){
		var StatusbarHeight = plus.navigator.getStatusbarHeight();
		console.log(StatusbarHeight+"高度")
		var header = document.querySelectorAll('.ImmersedStatusbar');
...
var apiToken = '5a7d3fec77613-100001';
var apiUrl   = 'http://api.hcoder.net/api/index.php?token='+apiToken+'&c=';
